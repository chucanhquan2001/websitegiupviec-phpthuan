...
if (isset($_POST['add_tai_khoan'])) {
    ...
    if ($dia_chi_err . $phone_err . $hon_nhan_err . $yeu_cau_err . $dich_vu_err . $user_err . $hinh_thuc_lam_viec_err . $muc_luong_err . $yeu_cau_err . $trang_thai_err . $tom_tat_err == "") {
        ...
        // 
        $them = ("INSERT INTO `tuyen_dung` ( `id_user`, `id_dichvu`, `yeu_cau`, `hinh_thuc_lam_viec`, `noi_lam_viec`, `muc_luong`,`tom_tat`, `mo_ta`, `status`, `phone`, `trang_thai`, `trang_thai_duyet`)
         VALUES ( '$user', '$dich_vu', '$yeu_cau', '$hinh_thuc_lam_viec', '$dia_chi', '$muc_luong','$tom_tat', '$mo_ta', $hon_nhan, '$phone', $trang_thai, $trang_thai_duyet);");
        $connect = connect();
        $stmt = $connect->prepare($them);
        $stmt->execute();
        echo $them;
        header("location:" . BASE_URL . "admin/khach_hang/index.php?msg=Thêm nhân viên thành công");
        die;
    }
}
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form_user">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="padding-right: 25px;">
                                    ...
                                    <div class="form-group">
                                        <label for="">Tình trạng thuê *</label>
                                        <div class="form-control" style="background-color: #fdf7f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control" style="background-color: #fdf7f7;">
                                            <label><input name="trang_thai_duyet" value="0" type="radio" checked> Đã được duyệt</label>&nbsp;&nbsp;
                                            <label><input name="trang_thai_duyet" value="1" type="radio"> Chưa được duyệt</label>
                                        </div>
