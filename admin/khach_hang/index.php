...
if (isset($_GET['id'])) {
    ...
    insert_delete_update("DELETE FROM tuyen_dung WHERE id = '$id'");
            ...
            <div class="row">
                ...
                <div class="col-md-9" style="margin-top: 40px;">
                    <div class="content_admin" style="background-color: #fdf7f7;border-radius: 10px;">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= ($item['trang_thai'] == 1) ? 'Đã có người thuê' : 'Chưa có người thuê' ?></td>
                                        <td><?= ($item['trang_thai_duyet'] == 1) ? 'Chưa duyệt' : 'Đã duyệt' ?></td>
                                        <td><?= $item['ma_thanh_toan'] ?></td>
                                        <td>
                                            <a href="edit_khach_hang.php?id=<?= $item['id'] ?>" class="btn btn-secondary" style="font-size: 12px"><i class="fas fa-edit"></i></a>
                                            <br>
                                            <br>
                        ...
                        <a href="add_khach_hang.php" class="btn btn-secondary">Thêm tài khoản</a>
                        <br>
                    </div>
