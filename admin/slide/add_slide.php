...
if (isset($_POST['add_slide'])) {
    ...
    if ($err_ten_anh . $error_hinh_anh == "") {
        insert_delete_update("INSERT INTO `slide`(`ten`, `hinh_anh`, `id_user`) VALUES ('$ten_anh','$imgname','$id_user')");
        header("Location:index.php?msg=Thêm slide thành công !");
    }
}
                            ...
                            <div class="row">
                                <div class="col-md-12" style="padding:0 25px 0 25px;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="ten_anh" placeholder="Tên ảnh" style="background-color: #fdf7f7;">
                                    ...
                                    <button type="submit" class="btn btn-secondary" name="add_slide">Thêm</button>
