...
if (isset($_POST['add_tai_khoan'])) {
    ...
    if (empty($_POST['kinh_nghiem'])) {
        $kinh_nghiem_err = " Xin mời bạn nhập kinh nghiệm làm việc của mình vào";
    } else {
    ...
    if ($dia_chi_err . $phone_err . $hon_nhan_err . $kinh_nghiem_err . $dich_vu_err . $user_err . $hinh_thuc_lam_viec_err . $muc_luong_err . $nguyen_vong_err . $trang_thai_err == "") {
        ...
        $them = ("update `nhan_vien` set  `dia_chi`= '$dia_chi', `phone` ='$phone', `status`= $hon_nhan, `kinh_nghiem`='$kinh_nghiem', `id_dichvu` = '$dich_vu', `id_user`='$user', `hinh_thuc_lam_viec`='$hinh_thuc_lam_viec', `muc_luong`='$muc_luong', `nguyen_vong`='$nguyen_vong', `trang_thai`=$trang_thai where id =$id");
        $connect = connect();
                ...
                <div class="col-md-9" style="margin-top: 40px;">
                    <div class="content_admin" style="width: 100%;background-color: #fdf7f7;border-radius: 10px;">
                        <div class="tieu_de" style="padding: 20px 0 0 10px;">
                            <h5>CẬP NHẬP NHÂN VIÊN </h5>
                        </div>
                        <br>
                        <?php foreach (selectall("select * from nhan_vien where id=$id") as $item) { ?>
                            <form action="<?= BASE_URL . 'admin/nhan_vien/edit_nhan_vien.php?id=' . $id ?>" method="post" enctype="multipart/form-data" class="form_user">
                                <div class="row">
                                    <div class="col-md-6" style="padding-left: 25px;">
                                        <div class="form-group">
                                            <label for="">Địa chỉ *</label>
                                            <input type="text" class="form-control" name="dia_chi" value="<?= $item['dia_chi'] ?>" style="background-color: #fdf7f7;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?= $item['phone'] ?>" name="phone" style="background-color: #fdf7f7;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kinh_nghiem" class="form-control">
                                                ...
                                                <option value="Chưa có kinh nghiệm" <?php if ($item['kinh_nghiem'] == "Chưa có kinh nghiệm") {
                                                                                        echo "selected";
                                                                                    } ?>>Chưa có kinh nghiệm</option>
                                                <option value="Kinh nghiệm dưới 1 năm" <?php if ($item['kinh_nghiem'] == "Kinh nghiệm dưới 1 năm") {
                                                                                            echo "selected";
                                                                                        } ?>>Kinh nghiệm dưới 1 năm</option>
                                                <option value="Kinh nghiệm 1 năm" <?php if ($item['kinh_nghiem'] == "Kinh nghiệm 1 năm") {
                                                                                        echo "selected";
                                                                                    } ?>>Kinh nghiệm 1 năm</option>
                                                <option value="Kinh nghiệm 2 năm" <?php if ($item['kinh_nghiem'] == "Kinh nghiệm 2 năm") {
                                                                                        echo "selected";
                                                                                    } ?>>Kinh nghiệm 2 năm</option>
                                                <option value="Kinh nghiệm 3 năm" <?php if ($item['kinh_nghiem'] == "Kinh nghiệm 3 năm") {
                                                                                        echo "selected";
                                                                                    } ?>>Kinh nghiệm 3 năm</option>
                                                <option value="Kinh nghiệm trên 3 năm" <?php if ($item['kinh_nghiem'] == "Kinh nghiệm trên 3 năm") {
                                                                                            echo "selected";
                                    ...
                                    <div class="col-md-6" style="padding-right: 25px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" value="<?php echo $item['muc_luong'] ?>" name="muc_luong" style="background-color: #fdf7f7;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nguyen_vong" value="<?php echo $item['nguyen_vong'] ?>" style="background-color: #fdf7f7;" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control" style="background-color: #fdf7f7;">
                                                <label><input name="trang_thai" value="0" type="radio" <?php echo ($item['trang_thai'] == 0) ? "checked" : " "; ?>> Chưa có người thuê</label>&nbsp;&nbsp;
                                                <label><input name="trang_thai" value="1" type="radio" <?php echo ($item['trang_thai'] == 1) ? "checked" : " "; ?>> Có người thuê</label>
                                            </div>
