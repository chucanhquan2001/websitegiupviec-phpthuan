...
$select = selectall("select * from setting where id=$id");
if (isset($_POST['them'])) {
    ...
    if ($ten_cong_ty_Err . $phone_Err . $dia_chi_Err . $phone_hotline_Err . $youtobe_url_Err . $instagram_url_Err . $facebook_url_Err . $zalo_url_Err . $logo_Err == "") {
        insert_delete_update("UPDATE `setting` SET `ten_cong_ty`='$ten_cong_ty',`phone`='$phone',`dia_chi`='$dia_chi',`email`='$email',`logo`='$path',`phone_hotline`='$phone_hotline',`youtobe_url`='$youtobe_url',`instagram_url`='$instagram_url',`facebook_url`='$facebook_url',`zalo_url`='$zalo_url' WHERE id=$id");
        header("location:" . BASE_URL . 'admin/web_setting/index.php?msg=Cập nhập thông tin thành công !');
        die;
    }
}
...
<head>
    ...
    <title>Cập nhập thông tin setting</title>
            ...
            <div class="row">
                ...
                <div class="col-md-9" style="margin-top: 40px;">
                    <?php foreach ($select as $item) { ?>
                        <form action="<?= BASE_URL . "admin/web_setting/edit_web_setting.php?id=" . $item['id'] ?>" method="post" enctype="multipart/form-data">
                            <div class="content_admin" style="width: 100%;background-color: #fdf7f7;border-radius: 10px;height:550px;">
                                <div class="tieu_de" style="padding: 20px 0 0 10px;margin-bottom:20px;">
                                    <h5>CẬP NHẬP THÔNG TIN SETTING</h5>
                                </div>
                                <div class="khoi1" style="float:left;width:400px;margin-right:20px;padding-left:10px;">
                                    <div class="form-group">
                                        <label for="">Tên công ty *</label>
                                        <input type="text" class="form-control" placeholder="Tên công ty" value="<?= $item['ten_cong_ty'] ?>" name="ten_cong_ty" style="background-color:#fdf7f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Phone" name="phone" value="<?= $item['phone'] ?>" style="background-color:#fdf7f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Đại chỉ" name="dia_chi" value="<?= $item['dia_chi'] ?>" style="background-color:#fdf7f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Email" name="email" value="<?= $item['email'] ?>" style="background-color:#fdf7f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="<?= BASE_URL . $item['logo'] ?>" width="50px" alt="">
                                ...
                                <div class="khoi2" style="float:left;width:400px;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Tên công ty" value="<?= $item['phone_hotline'] ?>" name="phone_hotline" style="background-color:#fdf7f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Link Youtobe" value="<?= $item['youtobe_url'] ?>" name="youtobe_url" style="background-color:#fdf7f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Link Instagram" value="<?= $item['instagram_url'] ?>" name="instagram_url" style="background-color:#fdf7f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Link Facebook" value="<?= $item['facebook_url'] ?>" name="facebook_url" style="background-color:#fdf7f7;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Link Zalo" value="<?= $item['zalo_url'] ?>" name="zalo_url" style="background-color:#fdf7f7;">
